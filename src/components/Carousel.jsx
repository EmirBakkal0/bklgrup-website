...
export function Carousel() {
  return (
    ...
    >
      ...
      <CarouselSlide img={`/stockp2.jpg`} header="İnşaat Grubu"  p="İnşaat Grubumuz 2007 yılından bu yana sektördeki deneyimi ve uzman kadrosuyla, modern yaşamın ihtiyaçlarına uygun, estetik ve kaliteli konut projeleri üretmektedir. Kurulduğu günden bu yana, yenilikçi yaklaşımıyla dikkat çeken şirketimiz, sürdürülebilirlik ilkesini benimseyerek çevreye duyarlı projeler geliştirmektedir.
